...
import com.platzimarket01.persistence.entity.ComprasProductosPK;
...
public class PurchaseItemMapperImpl implements PurchaseItemMapper {
    ...
    public ComprasProducto toComprasProducto(PurchaseItem item) {
        ...
        comprasProducto.setId( purchaseItemToComprasProductosPK( item ) );
    ...
    private Integer productoIdIdProducto(ComprasProducto comprasProducto) {
        ...
        ComprasProductosPK id = comprasProducto.getId();
        if ( id == null ) {
            return null;
        }
    ...
    protected ComprasProductosPK purchaseItemToComprasProductosPK(PurchaseItem purchaseItem) {
        ...
        comprasProductosPK.setIdProducto( purchaseItem.getProductId() );
