package com.platzimarket01.persistence.mapper;

import com.platzimarket01.domain.Purchase;
import com.platzimarket01.domain.PurchaseItem;
import com.platzimarket01.persistence.entity.Compra;
import com.platzimarket01.persistence.entity.ComprasProducto;
...
public class PurchaseMapperImpl implements PurchaseMapper {
    ...
    public Purchase toPurchase(Compra compra) {
        ...
        purchase.setClienteId( compra.getIdCliente() );
    ...
    public Compra toCompra(Purchase purchase) {
        ...
        compra.setIdCliente( purchase.getClienteId() );
